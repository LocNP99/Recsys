...
class LOCA_SVAE(BaseRecommender):
    def __init__(self, dataset, model_conf, device):
        super(LOCA_SVAE, self).__init__(dataset, model_conf)
    ...
    def train_single_model(self, local_num):
        ...
        local_model = SVAELocalWrapper(local_num, train_weight, test_weight, self.candidate_users[local_num], self.dataset, self.model_type, self.model_conf, self.device)
    ...
    def predict(self, user_ids, eval_pos_matrix, eval_items=None):
        ...
        # print('[LOCA_SVAE.predict] user_ids:', len(user_ids))
        # print('[LOCA_SVAE.predict] eval_pos_matrix:', eval_pos_matrix.shape)
        # print('[LOCA_SVAE.predict] batch_pos_matrix:', batch_pos_matrix.shape)
        # print('[LOCA_SVAE.predict] eval_output:', eval_output.shape)
        # print('[LOCA_SVAE.predict] weights_sum:', weights_sum.shape)
